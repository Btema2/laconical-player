...
buildscript {
    dependencies {
        constraints {
            ...
            add("classpath", "io.netty:netty-codec:4.2.18.Final")
            add("classpath", "io.netty:netty-codec-http:4.2.18.Final")
            add("classpath", "io.netty:netty-codec-http2:4.2.18.Final")
            add("classpath", "io.netty:netty-common:4.2.18.Final")
            add("classpath", "io.netty:netty-handler:4.2.18.Final")
            add("classpath", "io.netty:netty-handler-proxy:4.2.18.Final")
